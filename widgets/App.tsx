...
const App = () => {
  ...
  return (
    <div>
      <div className="flex h-screen w-full flex-wrap gap-10 md:flex-nowrap">
        <div className="flex w-full flex-col gap-5 p-10 md:max-w-md md:border-r">
          ...
          {widgetConfig.map((widget) => (
            <div
              key={widget.id}
              className="shadow- cursor-pointer rounded-xl p-[22px] text-xl font-bold text-neutral-blue"
              onClick={() => handleWidgetChange(widget.value)}
              style={
                selectedWidgetConfig?.label === widget.label
