...
import { formatDate } from '../../../helper/FormtDate';
import { CalendarValidate } from '../../../helper/CalendarValidation';
...
export type BookingModalPropsT = {
  ...
  setSelectedTime: ({ start, end }: { start: string; end: string }) => void;
...
const BookingModal: FC<BookingModalPropsT> = (props) => {
  ...
  const handleChangeTime = (time: string, type: string) => {
    if (type === 'start')
